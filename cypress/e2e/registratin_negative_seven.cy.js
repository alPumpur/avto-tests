describe('template spec', () => {
    it('Negative register test 5 (incorrect patronymic - другой язык)', () => {
        cy.fixture('data_test_registr_n').then(data => {
            ...
            cy.log('Ввод некорректного отчества (другой язык)')
            cy.get(':nth-child(3) > .form-control--medium > .form-input--text').type(data.patronymic_n)
        })
    })
})