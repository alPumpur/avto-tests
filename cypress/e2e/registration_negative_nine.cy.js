describe('template spec', () => {
    it('Negative register test 2 (incorrect password - недостаточное количестиво символов)', () => {
        cy.fixture('data_test_registr_n').then(data => {
            ...
            cy.get(':nth-child(3) > .form-control--medium > .form-input--password').type(data.password_n4)
            cy.get(':nth-child(4) > .form-control--medium > .form-input--password').type(data.password_n4)
        })
    })
})
